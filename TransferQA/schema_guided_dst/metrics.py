...
def get_average_and_joint_goal_accuracy(frame_ref, frame_hyp, service,
  ...
  # lower case the slot_values:
  for slot_name in frame_ref["state"]["slot_values"]:
    frame_ref["state"]["slot_values"][slot_name] = [value.lower() for value in frame_ref["state"]["slot_values"][slot_name]]
  for slot_name in frame_hyp["state"]["slot_values"]:
    frame_hyp["state"]["slot_values"][slot_name] = [value.lower() for value in frame_hyp["state"]["slot_values"][slot_name]]
